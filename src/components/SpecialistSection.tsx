        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              the kinetic chain from ground reaction forces through racket head speed. With a Master-level 
              Physical Education certification, every session is grounded in exercise science, motor learning 
              theory, and injury prevention protocols.
            </p>
